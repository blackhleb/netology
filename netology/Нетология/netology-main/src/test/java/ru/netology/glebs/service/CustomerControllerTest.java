...
import ru.netology.glebs.OperationHistoryApiApplicationTest;
import ru.netology.glebs.controller.CustomerController;
import ru.netology.glebs.controller.DTO.CustomerDTO;
import ru.netology.glebs.controller.DTO.CustomerGetResponse;
...
class CustomerControllerTest extends OperationHistoryApiApplicationTest {
    ...
    void addAndRemoveCustomer() {
        ...
        customerController.addCustomer(3, "Gleb");
        ...
        assertEquals("Gleb", newCustomer.getName());
