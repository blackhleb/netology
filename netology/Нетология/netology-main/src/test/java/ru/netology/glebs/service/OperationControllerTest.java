package ru.netology.glebs.service;

import org.junit.jupiter.api.Test;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.test.context.SpringBootTest;
import ru.netology.glebs.configuration.OperationProperties;
import ru.netology.glebs.controller.OperationController;
import ru.netology.glebs.controller.DTO.OperationDTO;
...
class OperationControllerTest {
    ...
    void addOperationsTest() throws InterruptedException {
        OperationDTO dto = new OperationDTO(1, 1, 100, "RUB", "Origin");
    ...
    void getOperationsTest() throws InterruptedException {
        OperationDTO operation1 = new OperationDTO(2, 1, 100, "RUB", "Origin");
        operationController.addOperation(operation1);
        Thread.sleep(properties.getTimeout() + 100);
        OperationDTO operation2 = new OperationDTO(3, 1, 200, "RUB", "Origin");
    ...
    void removeOperationsTest() throws InterruptedException {
        OperationDTO operation1 = new OperationDTO(4, 1, 100, "RUB", "Origin");
        operationController.addOperation(operation1);
        Thread.sleep(properties.getTimeout() + 100);
